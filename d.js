    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <Text style={[styles.textStyle, { flex: 5 }]}>
              To fund 's education to be{" "}
              <Text style={styles.hightLightText}>{infostore.want_data}</Text>,
              with inflation @{" "}
              <Text style={styles.hightLightText}>{percentageData}</Text>
            </Text>
            <SelectedItem
              dropDownStyle={{ flex: 1 }}
              data={percentageData}
              setData={setPercentageData}
          ...
          >
            A corpus of <Text style={styles.hightLightText}>0*</Text> is
            required when turns <Text style={styles.hightLightText}>18</Text>{" "}
            years in age
          </Text>
        ...
        >
          ...
          />
          <Text style={[styles.textStyle]}>
            When turns <Text style={styles.hightLightText}>18</Text>,
            considering your savings, if you would go for an Education Loan for
            remaining amount of <Text style={styles.hightLightText}>0</Text>,
            you would end up paying <Text style={styles.hightLightText}>0</Text>{" "}
...
const FinanceScreen = ({ storeinfo, infostore }) => {
  // console.log(infostore.investor_type);
  return (
    <View style={{ flex: 1, marginTop: moderateScale(10) }}>
      <CustomTextInput2 lable={"The amount required at current rates"} />
      <CustomTextInput2 lable={"How much have you saved for hims"} />
      <CustomTextInput2 lable={"Amount you save each month for 's education"} />
      <SelectedItem
